# terraform-aws-redis
Terraform module to create redis cluster

## Resource Created

* AWS Redis ElastiCache cluster
* Subnet Group for Redis ElastiCache cluster
* Security Group for Redis ElastiCache cluster
* Redis ElastiCache Replication Group
* Redis ElastiCache Parameter Group
* Security Group Rule for Redis Egress
